					...
					<div class="row d-flex align-items-center">
						...
						<!-- <div class="col-md-5">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Section ID -->	
						 		<span class="section-id">Solution unique</span>
                                                ...
                                                <div class="register-page-form">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="register-form-title">
                                                            <h3 class="s-32 w-700">Se connecter </h3>
                                                    ...
                                                    <!-- SIGN UP FORM -->
                                                    <form name="signupform" class="row sign-up-form" method="POST" action="traitement/traitement_connexion.php">									 

                                                        <!-- Login Separator -->
                                                        <div class="col-md-12 text-center">	
                                                            <div class="separator-line">Entrez vos information</div>
                                                        </div>

                                                        <!-- Form Input -->	
                                                        <div class="col-md-12">
                                                            <p class="p-sm input-header">Matricule</p>
                                                            <input class="form-control name" type="text" name="matricule" placeholder="2025103001"> 
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="wrap-input">
                                                                ...
                                                                <input class="form-control password" type="password" name="mot_de_passe" placeholder="****"> 
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-data">
                                                                <span>La céation de compte utilisateur est reservée qu'aux administrateurs! Clique
                                                                    <a href="terms.html">ici</a> pour lire le terme de l'utilisation de cette application
                                                        ...
                                                        <!-- Form Submit Button -->	
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn btn--theme hover--theme submit">Connexion</button>
                                                        </div> 								
