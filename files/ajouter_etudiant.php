					...
					<div class="row d-flex align-items-center">
						...
						<!-- <div class="col-md-5">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Title -->	
								<h2 class="s-46 w-700">Ajouter un nouvel étudiant</h2>

								<!-- Text -->	
								<p>
									L'ajout d'un étudiant est une tâche dediée uniquement aux administrateurs de ce site									
								</p>
                                                ...
                                                <div class="register-page-form">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="register-form-title">
                                                            <h3 class="s-32 w-700">Renseigner les informations de l'étudiant </h3>
                                                    ...
                                                    <!-- SIGN UP FORM -->
                                                    <form name="signupform" class="row sign-up-form" method="POST" action="traitement/traitement_ajout_etudiant.php">	
														
													
														<div class="col-md-12">
                                                            <p class="p-sm input-header">Nom</p>
                                                            <input class="form-control name" type="text" name="nom" placeholder="jacques..." required> 
                                                        </div>

                                                        <!-- Form Input -->	
                                                        <div class="col-md-12">
                                                            <p class="p-sm input-header">Matricule</p>
                                                            <input class="form-control name" type="text" name="matricule" placeholder="2025103001" required> 
                                                        </div>

														<div class="col-md-12">
                                                            <p class="p-sm input-header">Email</p>
                                                            <input class="form-control name" type="email" name="email" placeholder="tonmail@gmail.com" required> 
                                                        </div>

														<div class="col-md-12">
                                                            <p class="p-sm input-header">Faculté</p>
                                                            <input class="form-control name" type="text" name="faculte" placeholder="Sc informatique..." required> 
                                                        </div>

														<div class="col-md-12">
                                                            <p class="p-sm input-header">Niveau</p>
                                                            <input class="form-control name" type="text" name="niveau" placeholder="Bac 1..." required> 
                                                        </div>
                                            
                                                                                                            
                                                        <!-- Form Submit Button -->	
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn btn--theme hover--theme submit">Ajouter</button>
                                                        </div> 								
